...
import cartographer.engine.io.reader.ExcelArrayReader;
...
{
    private static Logger LOG = LogManager.getLogger(ExcelImporter.class);


    public ExcelImporter(final Conversion conversion)
    {
        super(conversion);
    }
            ...
            throws Exception
    {
        ...
        try (AbstractArrayReader reader = new ExcelArrayReader(file, progressBar))
        {
